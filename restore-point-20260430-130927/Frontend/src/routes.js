...
const OpportunitiesKanban = React.lazy(() => import('./views/opportunities/OpportunitiesKanban'))
const OpportunitiesTable = React.lazy(() => import('./views/opportunities/OpportunitiesTable'))
const OpportunitiesDashboard = React.lazy(() => import('./views/opportunities/OpportunitiesDashboard'))
...
const routes = [
  ...
  { path: '/opportunities/kanban', name: 'Opportunities Kanban', element: OpportunitiesKanban },
  { path: '/opportunities/table', name: 'Opportunities Table', element: OpportunitiesTable },
  { path: '/opportunities/dashboard', name: 'Opportunities Dashboard', element: OpportunitiesDashboard },
]
